...
By downloading, installing, or using UniPlan ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.
...
- **Local-first**: Your data is stored on your device by default
- **Cloud Sync is optional**: Data is only sent to our servers if you explicitly enable cloud sync
- **Encryption**: All cloud-synced data is AES-256 encrypted before leaving your device
...
- Your data is synchronized with Firebase Firestore
- All data is encrypted client-side using AES-256 before transmission
- You are responsible for maintaining the confidentiality of your encryption PIN and password
...
- The App will meet your specific academic needs
